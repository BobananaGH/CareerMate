...
from .views import SendMessageAPIView, ConversationListAPIView, ConversationDetailAPIView, RoadmapAPIView
...
urlpatterns = [
    ...
    path("roadmap/", RoadmapAPIView.as_view(), name="chat-roadmap"),
]
